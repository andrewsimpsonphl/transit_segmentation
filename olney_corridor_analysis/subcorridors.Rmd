...
f <- function(route_num, direction) {
  p <- plot_joyplot_runtimes(dat, route_num = route_num, direction = direction, pattern_list = primary_patterns[[1]], corridor_name = subcorridor_results_line$corridor_name[[1]], min_dur, max_dur)
